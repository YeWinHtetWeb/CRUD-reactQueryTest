...
const BlogForm = ({createSubmit, updateSubmit, prevPost})=>{
    const {id} = useParams();
    ...
    return (
        <>
            <h1 className="text-3xl font-bold text-center my-5">Blog {isEdit? "Edit" : "Create"} Page</h1>
            <form className="w-[48em] flex flex-col mx-auto gap-6" onSubmit={submitHandler}>
                <div>
                    <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Blog Title</label>
                ...
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                        ...
                        <textarea value={details} onChange={(e)=>setDetails(e.target.value)} id="editor" rows="8" className="block resize-none w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                    </div>
                </div>
                <button type="submit" className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
